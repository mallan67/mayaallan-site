// src/app/books/psilocybin-integration/page.tsx
  ...
  return (
    <main className="max-w-3xl mx-auto p-6">
      ...
      <div className="flex gap-6">
        <div>
          <img src="/images/cover.png" alt="Cover" width={360} height={540} className="rounded border" />
        </div>

        <div className="flex-1">
          <p className="mb-4">An educational companion for integrating psychedelic experiences into day-to-day life.</p>
          ...
          <section className="mt-6 text-sm text-slate-600">
            ...
            <p>This is a sample public cover page to make the product discoverable while the admin & DB are being prepared.</p>
          </section>
        </div>
      </div>
    </main>
